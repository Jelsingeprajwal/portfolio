...
import { Instagram, Github, Linkedin, Resume } from "../assets/index";
       ...
       absolute left-[50%] -translate-x-[50%] -translate-y-[50%] bg-primaryBlue blur-[200px] z-0"
        ...
        <div className="text-center z-10 flex flex-col gap-4 mt-32 items-center justify-between">
          ...
          <div>
            <a href={Resume} download={true} target="_blank">
              <Button
                classes={
                  "bg-primaryBlue text-white text-small md:px-[34px] font-light  w-[7.5rem] md:w-[180px] text-sm "
                }
                text={"View Resume"}
              />
            </a>
        ...
        <div className="mt-40 md:mt-0 ">
          ...
          <div className={` mx-auto ${styles.flexCenter}  gap-5`}>
            <a
              href="https://www.instagram.com/sangameshjelsinge0111/"
              target="_blank"
            >
              <img
                src={Instagram}
            ...
            <a
              href="https://www.linkedin.com/in/jelsinge-prajwal"
              target="_blank"
            >
              <img
                src={Linkedin}
            ...
            <a href="https://github.com/Jelsingeprajwal" target="_blank">
              <img
                src={Github}
                className="w-6 opacity-80 hover:opacity-100 hover:scale-105 transition-all ease-in-out"
                alt=""
